-- Complete Test Data for EduSure Platform
-- Creates 15+ students, 10-12 uploads, community posts, calendar events, and transactions
-- All data will be immediately visible and properly formatted
...
-- ========================================
-- STEP 2: CREATE 12 MATERIAL UPLOADS (IMMEDIATELY APPROVED)
-- ========================================

-- Clear existing test materials (optional)
-- DELETE FROM materials WHERE title LIKE '%Test Material%';

-- Insert 12 diverse material uploads with immediate approval
-- Using only basic required fields to avoid constraints
...
-- Verify data Creation and show summary
SELECT '=== TEST DATA CREATION COMPLETE ===' as info;
