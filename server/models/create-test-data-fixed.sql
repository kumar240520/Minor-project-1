...
-- Using the correct table structure from setup-user-profiles.sql (lowercase 'users' table)
...
-- ========================================
-- 6. UPDATE USER COINS BASED ON TRANSACTIONS
-- ========================================
