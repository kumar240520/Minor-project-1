...
(gen_random_uuid(), 'Data Structures Complete Guide', 'Comprehensive guide to data structures including arrays, linked lists, trees, and graphs', 'Data Structures', 'https://test-files.edu/data-structures.pdf', (SELECT id FROM users WHERE email = 'alice.johnson@cs.test.edu' LIMIT 1), 'approved', 45, timezone('utc', now())),
